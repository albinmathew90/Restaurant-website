# Restaurant-website First Web Project
...
Menu Cards: Organized dish layouts using Bootstrap's card components.
...
Overriding Bootstrap classes with custom CSS.

Organizing file structures (images, CSS folders).
